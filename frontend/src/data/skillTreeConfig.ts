...
export const createFireSkillTree = (characterId: string): SkillTree => ({
  ...
  nodes: [
      ...
      effects: [
        {
          ...
          target: 'self',
          value: 10,
          scaling: { baseValue: 10, perRank: 5, scalingType: 'additive', diminishingReturns: false },
          isPercentage: false,
          stackable: true,
    ...
    },
    {
      ...
      maxRank: 3,
      currentRank: 0,
      prerequisites: [{ type: 'node_rank', nodeId: 'fire_spark', minimumRank: 1 }],
      unlocks: ['fire_blast', 'burning_hands'],
      position: { x: 1, y: 1, tier: 'basic' },
      costs: [{ type: 'skill_points', amount: 2, scaling: 'linear', rankMultiplier: 1.5 }],
      requirements: [],
      effects: [
        {
          ...
          target: 'self',
          value: 1,
          scaling: { baseValue: 25, perRank: 10, scalingType: 'additive', diminishingReturns: false },
          isPercentage: false,
          stackable: false,
      ...
      effects: [
        {
          ...
          target: 'self',
          value: 15,
          scaling: { baseValue: 15, perRank: 8, scalingType: 'additive', diminishingReturns: true, softCap: 75 },
          isPercentage: true,
          stackable: false,
    ...
    // Tier 2 - Intermediate
    {
      ...
      costs: [{ type: 'skill_points', amount: 3, scaling: 'linear', rankMultiplier: 2 }],
      requirements: [{ type: 'level', value: 10, description: 'Requires character level 10' }],
      effects: [
        {
          ...
          target: 'self',
          value: 1,
          scaling: { baseValue: 40, perRank: 15, scalingType: 'additive', diminishingReturns: false },
          isPercentage: false,
          stackable: false,
      ...
      effects: [
        {
          ...
          target: 'enemies',
          value: 5,
          scaling: { baseValue: 5, perRank: 3, scalingType: 'additive', diminishingReturns: false },
          isPercentage: false,
          stackable: true,
          maxStacks: 3,
          triggers: [{ event: 'on_attack', chance: 30, description: 'On melee attack' }],
      ...
      effects: [
        {
          ...
          target: 'enemies',
          value: 3,
          scaling: { baseValue: 3, perRank: 2, scalingType: 'additive', diminishingReturns: false },
          isPercentage: false,
          stackable: false,
        ...
        },
        {
          ...
          target: 'allies',
          value: 2,
          scaling: { baseValue: 2, perRank: 1, scalingType: 'additive', diminishingReturns: false },
          isPercentage: false,
          stackable: false,
    ...
    // Tier 3 - Advanced (Specialization Paths)
    {
      ...
      costs: [
        { type: 'skill_points', amount: 5, scaling: 'exponential', rankMultiplier: 2 },
        { type: 'special_currency', amount: 1, scaling: 'fixed', rankMultiplier: 1 }
      ],
      requirements: [
        { type: 'level', value: 20, description: 'Requires character level 20' },
        { type: 'element_affinity', value: 'fire', description: 'Must have high fire affinity' }
      ],
      effects: [
        {
          id: 'inferno_ability',
          ...
          target: 'enemies',
          value: 100,
          scaling: { baseValue: 100, perRank: 50, scalingType: 'multiplicative', diminishingReturns: false },
          isPercentage: false,
          stackable: false,
    ...
    },
    {
      ...
      costs: [{ type: 'skill_points', amount: 4, scaling: 'linear', rankMultiplier: 2 }],
      requirements: [{ type: 'level', value: 18, description: 'Requires character level 18' }],
      effects: [
        {
          ...
          target: 'self',
          value: 25,
          scaling: { baseValue: 25, perRank: 15, scalingType: 'additive', diminishingReturns: false },
          isPercentage: true,
          stackable: false,
      ...
      effects: [
        {
          ...
          target: 'allies',
          value: 30,
          scaling: { baseValue: 30, perRank: 10, scalingType: 'additive', diminishingReturns: false },
          isPercentage: false,
          stackable: false,
    ...
    // Tier 4 - Master (Ultimate abilities)
    {
      ...
      description: 'The ultimate fire mastery - rise from ashes stronger than before',
      tier: 'master',
      maxRank: 1,
      currentRank: 0,
      prerequisites: [
      ...
      costs: [
        { type: 'skill_points', amount: 10, scaling: 'fixed', rankMultiplier: 1 },
        { type: 'special_currency', amount: 5, scaling: 'fixed', rankMultiplier: 1 }
      ],
      requirements: [
        { type: 'level', value: 30, description: 'Requires character level 30' },
        { type: 'transformation_mastery', value: 'advanced', description: 'Must master fire transformation' }
      ],
      effects: [
        {
          ...
          target: 'self',
          value: 1,
          scaling: { baseValue: 1, perRank: 0, scalingType: 'fixed', diminishingReturns: false },
          isPercentage: false,
          stackable: false,
          conditions: [{ type: 'health_threshold', value: 0, operator: 'less_equal', description: 'When health reaches 0' }],
  ...
  connections: [
    { fromNode: 'fire_spark', toNode: 'fire_bolt', connectionType: 'prerequisite' },
    { fromNode: 'fire_spark', toNode: 'fire_resistance', connectionType: 'prerequisite' },
    { fromNode: 'fire_bolt', toNode: 'fire_blast', connectionType: 'prerequisite' },
    { fromNode: 'fire_bolt', toNode: 'burning_hands', connectionType: 'prerequisite' },
    { fromNode: 'fire_resistance', toNode: 'heat_aura', connectionType: 'prerequisite' },
    { fromNode: 'fire_blast', toNode: 'inferno', connectionType: 'upgrade' },
    { fromNode: 'burning_hands', toNode: 'flame_warrior', connectionType: 'upgrade' },
    { fromNode: 'heat_aura', toNode: 'guardian_flame', connectionType: 'upgrade' },
    { fromNode: 'inferno', toNode: 'phoenix_rebirth', connectionType: 'mastery' }
  ],
  specializations: [
    {
      id: 'destroyer',
      ...
      unlockRequirements: [
        { type: 'nodes_unlocked', value: 3, description: 'Unlock 3 fire nodes' }
      ],
      masteryRequirements: [
        {
          level: 'apprentice',
          requirements: [
            { type: 'specific_nodes', value: 'fire_blast', description: 'Learn Fire Blast', nodeIds: ['fire_blast'] }
          ],
          rewards: [
            { type: 'stat_bonus', value: '10% increased fire damage', description: '+10% Fire Damage' }
          ]
        },
        {
          level: 'adept',
          requirements: [
            { type: 'specific_nodes', value: 'inferno', description: 'Learn Inferno', nodeIds: ['inferno'] }
          ],
          rewards: [
            { type: 'ability_unlock', value: 'flame_mastery', description: 'Unlock Flame Mastery passive' }
          ]
        }
      ],
      pathBonuses: [
          ...
          effects: [
            {
              ...
              target: 'self',
              value: 15,
              scaling: { baseValue: 15, perRank: 0, scalingType: 'fixed', diminishingReturns: false },
              isPercentage: true,
              stackable: false,
    ...
    },
    {
      id: 'striker',
      name: 'Flame Striker',
      description: 'Hybrid combat style mixing fire magic with physical prowess',
      element: 'fire',
      theme: 'striker',
      ...
      branchNodes: ['fire_bolt'],
      unlockRequirements: [
        { type: 'nodes_unlocked', value: 2, description: 'Unlock 2 fire nodes' }
      ],
      masteryRequirements: [
        {
          level: 'apprentice',
          requirements: [
            { type: 'specific_nodes', value: 'burning_hands', description: 'Learn Burning Hands', nodeIds: ['burning_hands'] }
          ],
          rewards: [
            { type: 'stat_bonus', value: '5% increased melee damage', description: '+5% Melee Damage' }
          ]
        }
      ],
      pathBonuses: [
          ...
          effects: [
            {
              ...
              target: 'self',
              value: 10,
              scaling: { baseValue: 10, perRank: 0, scalingType: 'fixed', diminishingReturns: false },
              isPercentage: true,
              stackable: false,
              description: 'Melee attacks boost fire spell damage and vice versa',
    ...
    },
    {
      ...
      unlockRequirements: [
        { type: 'nodes_unlocked', value: 2, description: 'Unlock 2 defensive fire nodes' }
      ],
      masteryRequirements: [
        {
          level: 'apprentice',
          requirements: [
            { type: 'specific_nodes', value: 'heat_aura', description: 'Learn Heat Aura', nodeIds: ['heat_aura'] }
          ],
          rewards: [
            { type: 'stat_bonus', value: '15% increased healing power', description: '+15% Healing Power' }
          ]
        }
      ],
      pathBonuses: [
          ...
          effects: [
            {
              ...
              target: 'allies',
              value: 25,
              scaling: { baseValue: 25, perRank: 0, scalingType: 'fixed', diminishingReturns: false },
              isPercentage: true,
              stackable: false,
...
export const createWaterSkillTree = (characterId: string): SkillTree => ({
  ...
  nodes: [
      ...
      effects: [
        {
          ...
          target: 'self',
          value: 8,
          scaling: { baseValue: 8, perRank: 4, scalingType: 'additive', diminishingReturns: false },
          isPercentage: false,
          stackable: true,
    ...
    },
    {
      ...
      maxRank: 4,
      currentRank: 0,
      prerequisites: [{ type: 'node_rank', nodeId: 'water_drop', minimumRank: 2 }],
      unlocks: ['life_stream'],
      position: { x: 1, y: 2, tier: 'intermediate', branch: 'support' },
      costs: [{ type: 'skill_points', amount: 3, scaling: 'linear', rankMultiplier: 1.5 }],
      requirements: [],
      effects: [
        {
          ...
          target: 'allies',
          value: 20,
          scaling: { baseValue: 20, perRank: 8, scalingType: 'additive', diminishingReturns: false },
          isPercentage: false,
          stackable: false,
  ...
  connections: [
    { fromNode: 'water_drop', toNode: 'healing_spring', connectionType: 'prerequisite' }
  ],
  specializations: [
    {
      id: 'healer',
      ...
      unlockRequirements: [
        { type: 'nodes_unlocked', value: 2, description: 'Unlock 2 water nodes' }
      ],
      masteryRequirements: [],
      pathBonuses: [],
      synergies: [],
  ...
  masteryLevel: 0,
  unlockRequirements: [
    { type: 'character_level', value: 5, description: 'Requires character level 5' }
  ],
  isUnlocked: false,
  prestigeLevel: 0,
  resetCount: 0,
