...
export const elementEffectiveness = {
  Light: {
    strong: ['Darkness'],
    weak: ['Void'],
    neutral: ['Fire', 'Water', 'Earth', 'Air', 'Ice', 'Lightning', 'Nature', 'Crystal'],
    amplified: ['Celestial'],
  },
  Darkness: {
    strong: ['Light'],
  ...
  Fire: {
    strong: ['Ice', 'Nature'],
    weak: ['Water'],
    neutral: ['Light', 'Darkness', 'Earth', 'Air', 'Lightning', 'Crystal'],
    amplified: ['Celestial', 'Void'],
  },
  Water: {
    strong: ['Fire'],
    weak: ['Lightning', 'Nature'],
    neutral: ['Light', 'Darkness', 'Earth', 'Air', 'Ice', 'Crystal'],
    amplified: ['Celestial', 'Void'],
  },
  Earth: {
    strong: ['Lightning'],
    weak: ['Air', 'Nature'],
    neutral: ['Light', 'Darkness', 'Fire', 'Water', 'Ice', 'Crystal'],
    amplified: ['Celestial', 'Void'],
  },
  Air: {
    strong: ['Earth'],
    weak: ['Lightning'],
    neutral: ['Light', 'Darkness', 'Fire', 'Water', 'Ice', 'Nature', 'Crystal'],
    amplified: ['Celestial', 'Void'],
  },
  Ice: {
    strong: ['Water'],
    weak: ['Fire'],
    neutral: ['Light', 'Darkness', 'Earth', 'Air', 'Lightning', 'Nature', 'Crystal'],
    amplified: ['Celestial', 'Void'],
  },
  Lightning: {
    strong: ['Air', 'Water'],
    weak: ['Earth'],
    neutral: ['Light', 'Darkness', 'Fire', 'Ice', 'Nature', 'Crystal'],
    amplified: ['Celestial', 'Void'],
  },
  Nature: {
    strong: ['Earth', 'Water'],
    weak: ['Fire'],
    neutral: ['Light', 'Darkness', 'Air', 'Ice', 'Lightning', 'Crystal'],
    amplified: ['Celestial', 'Void'],
  },
  Celestial: {
    strong: [],
  ...
  Crystal: {
    strong: [],
    weak: [],
    neutral: ['Light', 'Darkness', 'Fire', 'Water', 'Earth', 'Air', 'Ice', 'Lightning', 'Nature'],
    amplified: ['Celestial', 'Void'],
  },
};
  ...
  steps: [
    {
      id: 'welcome',
      target: 'header',
      content: 'Welcome to the Magical Girl Simulator!',
    },
    {
      id: 'resources',
      target: 'resource-display',
      content: 'Here you can see your current resources',
    },
    {
      id: 'training',
      target: 'training-tab',
      content: 'Start here to train your magical girls',
    },
    {
      id: 'missions',
      target: 'missions-tab',
      content: 'Complete missions to earn rewards',
    },
    {
      id: 'collection',
      target: 'collection-tab',
      content: 'View your magical girl collection',
    },
  ],
  autoStart: true,
  canSkip: true,
