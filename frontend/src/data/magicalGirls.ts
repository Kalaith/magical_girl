...
import type { MagicalGirl, MagicalElement, Rarity, Specialization } from '../types/magicalGirl';
...
export const initialMagicalGirls: MagicalGirl[] = [
  {
    ...
    avatar: {
      base: {
        ...
        accessories: [{ type: 'ribbon', position: 'hair', color: 'blue', special: false }],
        pose: 'friendly',
  ...
  },
  {
    ...
    avatar: {
      base: {
        ...
        accessories: [{ type: 'headband', position: 'head', color: 'blue', special: false }],
        pose: 'dynamic',
