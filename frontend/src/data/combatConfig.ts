...
export const COMBAT_CONFIG = {
      ...
      positions: [
        {
          ...
          column: 2,
          role: "Tank",
          modifiers: [{ type: "defense", value: 10, source: "formation" }],
          restrictions: [],
        },
        {
          row: 2,
          column: 1,
          role: "Damage",
          modifiers: [{ type: "damage", value: 5, source: "formation" }],
          restrictions: [],
        },
        {
          row: 2,
        ...
        },
        {
          ...
          column: 2,
          role: "Support",
          modifiers: [{ type: "speed", value: 5, source: "formation" }],
          restrictions: [],
        },
      ],
      bonuses: [
      ...
      positions: [
        {
          ...
          column: 1,
          role: "Damage",
          modifiers: [{ type: "damage", value: 15, source: "formation" }],
          restrictions: [],
        },
        {
          row: 1,
        ...
        },
        {
          ...
          column: 2,
          role: "Damage",
          modifiers: [{ type: "damage", value: 20, source: "formation" }],
          restrictions: [],
        },
        {
          row: 3,
          column: 2,
          role: "Support",
          modifiers: [{ type: "speed", value: 10, source: "formation" }],
          restrictions: [],
        },
      ],
      bonuses: [
      ...
      positions: [
        {
          ...
          column: 2,
          role: "Tank",
          modifiers: [{ type: "defense", value: 25, source: "formation" }],
          restrictions: [],
        },
        {
          row: 2,
          column: 1,
          role: "Tank",
          modifiers: [{ type: "defense", value: 15, source: "formation" }],
          restrictions: [],
        },
        {
          row: 2,
  ...
  getEnvironment: (environmentId: string): BattleEnvironment => {
    ...
    return (
      environments[environmentId as keyof typeof environments] ||
  ...
  formulas: {
    damageCalculation: (
      ...
      return Math.max(
        1,
        Math.floor((baseDamage + attack - defense / 2) * modifiers),
      );
    },
...
export const COMBAT_UTILS = {
  calculateElementalDamage: (
    ...
    const advantages =
      COMBAT_CONFIG.elementAdvantages[
        attackerElement as keyof typeof COMBAT_CONFIG.elementAdvantages
      ] || [];
    ...
    const targetAdvantages =
      COMBAT_CONFIG.elementAdvantages[
        targetElement as keyof typeof COMBAT_CONFIG.elementAdvantages
      ] || [];
  ...
  isInRange: (caster: { position: { row: number; column: number; }; }, target: { position: { row: number; column: number; }; }, range: number): boolean => {
    const distance = COMBAT_UTILS.calculateDistance(
      caster.position,
      target.position,
    );
