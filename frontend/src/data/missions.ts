...
import type {
  Mission,
  GameMissionType as MissionType,
  MissionCategory,
  Difficulty,
} from "../types";
...
export const initialMissions: Mission[] = [
  {
    ...
    name: "First Steps",
    description:
      "Learn the basics of being a magical girl through simple training exercises.",
    type: "Tutorial",
    category: "Training",
    difficulty: "Tutorial",
    requirements: [],
    objectives: [
      {
        ...
        condition: {
          type: "simple",
          rules: [
            { field: "training_sessions", operator: "greater", value: 0 },
          ],
        },
        progress: 0,
        maxProgress: 1,
        ...
        isHidden: false,
        hints: [
          "Go to the Training section and select a basic training exercise",
        ],
      },
    ],
    rewards: [
  ...
  },
  {
    ...
    description:
      "A kitten is stuck in a tree and needs your help! Use your magical abilities to safely bring it down.",
    type: "Story",
    category: "Rescue",
    difficulty: "Easy",
    requirements: [
    ...
    objectives: [
      {
        ...
        condition: {
          type: "simple",
          rules: [
            { field: "location", operator: "equals", value: "old_oak_tree" },
          ],
        },
        progress: 0,
        maxProgress: 1,
        ...
        hints: [
          ...
          "Listen for the kitten's meowing",
        ],
      },
      {
        id: "calm_kitten",
        ...
        condition: {
          type: "simple",
          rules: [{ field: "charm_check", operator: "greater", value: 10 }],
        },
        progress: 0,
        maxProgress: 1,
        isCompleted: false,
        ...
        isHidden: false,
        hints: [
          "Speak softly to the kitten",
          "Your charm stat affects success",
        ],
      },
      {
        id: "rescue_safely",
        ...
        condition: {
          type: "simple",
          rules: [{ field: "rescue_method", operator: "exists", value: true }],
        },
        progress: 0,
        maxProgress: 1,
        isCompleted: false,
        ...
        isHidden: false,
        hints: [
          "Consider using your magical abilities",
          "Think of a gentle approach",
        ],
      },
    ],
    rewards: [
    ...
    location: {
      ...
      name: "Central Park",
      description:
        "A peaceful park in the heart of the city, filled with tall trees and walking paths",
      type: "City",
      environment: {
        weather: "Clear",
        timeOfDay: "Afternoon",
          ...
          choices: [
            {
              ...
              consequences: [
                { type: "story", target: "reputation", effect: "+1" },
              ],
            ...
            },
            {
              ...
              consequences: [
                { type: "mission", target: "time_pressure", effect: "+300" },
              ],
            },
          ],
        },
  ...
  },
  {
    ...
    description:
      "Mysterious shadows have been appearing around the school. Investigate these supernatural occurrences and discover their source.",
    type: "Story",
    ...
    objectives: [
      {
        ...
        condition: {
          type: "simple",
          rules: [{ field: "clues_collected", operator: "greater", value: 2 }],
        },
        progress: 0,
        maxProgress: 3,
        isCompleted: false,
      ...
      },
      {
        ...
        condition: {
          type: "simple",
          rules: [{ field: "clues_analyzed", operator: "equals", value: true }],
        },
        progress: 0,
        maxProgress: 1,
        isCompleted: false,
        ...
        isHidden: false,
        hints: [
          "Analyze the collected clues",
          "Look for patterns in the sightings",
        ],
      },
      {
        id: "confront_shadows",
        ...
        isHidden: false,
        hints: [
          "Light-based attacks are effective",
    ...
    location: {
      ...
      description:
        "The school where magical girls learn to control their powers",
      type: "School",
      environment: {
        weather: "Cloudy",
        timeOfDay: "Evening",
      ...
      characters: [
        {
          ...
          dialogue: {
            serious: [
              ...
              "Be very careful with shadow magic.",
            ],
            helpful: [
  ...
  weekly: [
    {
          ...
          variations: [
            {
              ...
              condition: {
                type: "simple",
                rules: [
                  { field: "boss_defeated", operator: "equals", value: true },
                ],
              },
              difficulty: 3,
              rewards: [],
      ...
      seasons: ["all"],
      requirements: [
        { type: "level", value: 5, description: "Must be level 5 or higher" },
      ],
    },
  ],
};
