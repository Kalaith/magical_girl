...
export const FORMATION_TEMPLATES: FormationTemplate[] = [
  ...
  },
  {
    ...
    unlockRequirements: [{ type: "level", value: 15 }],
    category: "defensive",
  },
  {
    id: "elemental_circle",
  ...
  },
  {
    ...
    unlockRequirements: [{ type: "level", value: 25 }],
    category: "support",
  },
];
...
export const POSITION_ROLES: Record<
  PositionRole,
  {
    name: string;
    description: string;
...
export const SYNERGY_TIER_REQUIREMENTS: Record<
  SynergyTier,
  {
    usageCount: number;
    successRate: number;
