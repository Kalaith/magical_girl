...
export const initialTrainingSessions: TrainingSession[] = [
  {
    ...
    description:
      "Focus your mind and connect with your inner magical energy through simple meditation techniques.",
    type: "Mental",
    category: "Focus",
    difficulty: "Beginner",
  ...
  },
  {
    ...
    description:
      "Build your physical strength and endurance through targeted exercises designed for magical girls.",
    type: "Physical",
    category: "Stat_Boost",
    difficulty: "Beginner",
  ...
  },
  {
    ...
    description:
      "Learn to channel and control your magical energy with precision and stability.",
    type: "Magic",
  ...
  },
  {
    ...
    description:
      "Practice your combat techniques against magical training dummies and obstacles.",
    type: "Combat",
  ...
  },
  {
    ...
    description:
      "Deepen your connection with your magical element and learn advanced elemental techniques.",
    type: "Elemental",
    ...
    requirements: [
      ...
      },
      {
        ...
        description:
          "Must have completed Magic Control Basics at least 5 times",
      },
    ],
    effects: [
      {
  ...
  },
  {
    ...
    description:
      "Train with other magical girls to improve teamwork and combination abilities.",
    type: "Team",
  ...
  },
  {
    ...
    description:
      "Practice your magical girl transformation to reduce energy cost and improve effectiveness.",
    type: "Special",
    ...
    upgrades: [
      {
        ...
        benefits: [
          {
            type: "bonus",
            value: { type: "efficiency", value: 1.2 },
            description: "Increased training efficiency",
          },
        ],
        requirements: [],
        isUnlocked: true,
    ...
    bonuses: [
      {
        ...
        value: 1.2,
        trainingTypes: ["Mental", "Spiritual"],
      },
...
export const trainingEquipment = [
  {
    ...
    description:
      "Weights that adjust to provide optimal resistance for magical girl training",
    type: "Weights" as const,
    rarity: "Common" as const,
    bonuses: [{ type: "stat_gain", value: 1.2, trainingTypes: ["Physical"] }],
    durability: 100,
    maxDurability: 100,
  ...
  },
  {
    ...
    description:
      "A crystal that helps concentrate magical energy during training",
