    ...
    >
      <div className="space-y-6">
              ...
              >
                ...
                <div className="text-center mb-2">
                      ...
                      : result.character.element === "Water"
                        ...
                        : result.character.element === "Earth"
                          ...
                          : result.character.element === "Air"
                            ? "💨"
                            : result.character.element === "Light"
                              ? "☀️"
                              : result.character.element === "Darkness"
                                ? "🌙"
                                : result.character.element === "Ice"
                                  ? "❄️"
                  ...
                  <div className="flex justify-center mb-1">
                    {Array.from(
                      { length: getRarityStars(result.rarity) },
                      (_, i) => (
                        <span key={i} className="text-xs text-yellow-400">
                          ⭐
                        </span>
        ...
        <div className="flex justify-center space-x-4 pt-4">
          <Button variant="primary" onClick={onClose} className="px-8 py-3">
            Continue
          </Button>
        </div>
      </div>
