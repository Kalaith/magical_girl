        ...
        return (
          <label className="flex items-center space-x-2">
            <input
              ...
              className="rounded"
            />
            <span className="text-white">{setting.displayName || setting.name}</span>
          </label>
        );
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                max={setting.constraints?.max || 100}
...
{/* Warning functionality removed - not supported by GameSetting type */}
    </div>
  );
};
...
const SettingsCategoryComponent: React.FC<SettingsCategoryProps> = ({
  ...
  const filteredSettings = useMemo(() => {
    ...
    return category.settings.filter(
      (setting) =>
        setting.label.toLowerCase().includes(searchQuery.toLowerCase()) ||
        setting.description
          ?.toLowerCase()
          .includes(searchQuery.toLowerCase()) ||
        setting.tags?.some((tag) =>
...
export const EnhancedSettingsPanel: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<
    "settings" | "profiles" | "optimization" | "accessibility"
  >("settings");
  ...
  const optimizationSuggestions =
    enhancedSettingsState.optimizationSuggestions || [];
          ...
          <div>
            <div className="mb-6">
              ...
              <p className="text-gray-400">
                Suggestions to improve your game experience
              </p>
            </div>
                ...
                <div className="space-y-3">
                  <div className="p-3 bg-yellow-900 bg-opacity-30 rounded border border-yellow-500">
                    ...
                    <p className="text-sm text-gray-300">
                      Consider increasing minimum font size for better
                      readability
                    </p>
                  </div>
                  ...
                  <div className="p-3 bg-green-900 bg-opacity-30 rounded border border-green-500">
                    ...
                    <p className="text-sm text-gray-300">
                      Good ARIA label coverage detected
                    </p>
                  </div>
                </div>
