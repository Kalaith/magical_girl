        ...
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2 mb-2">
              <span
                className={`text-sm font-medium ${typeColors[training.type]}`}
              >
                {training.type}
              </span>
              <span className="text-gray-300">•</span>
              <span
                className={`text-xs px-2 py-1 rounded-full font-medium ${difficultyColors[training.difficulty]}`}
              >
                {training.difficulty}
              </span>
            </div>
        ...
        <div className="space-y-2 mb-4">
          ...
          {training.effects.length > 0 && (
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <span>
                {training.effects.length} Training Effect
                {training.effects.length > 1 ? "s" : ""}
              </span>
            </div>
          )}
        </div>
