  ...
  return (
    <div className="p-6 space-y-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-magical-primary mb-2">Missions</h1>
        <p className="text-gray-600">Send your magical girls on exciting adventures</p>
      </div>
      ...
      {selectedMission && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <Card className="max-w-2xl w-full mx-4 p-6">
            ...
            <p className="text-gray-600 mb-4">Detailed mission information will be shown here.</p>
